    ...
    <main id="AjukanEvent">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="w-full mt-2 flex justify-center items-center">
          <Link href="/addEvent">
            <button className="bg-button-dark text-white py-2 px-6 rounded-2xl hover:bg-purple-200 shadow-lg transition-transform duration-300 transform hover:scale-110 active:scale-95">
