      ...
      <div className="flex flex-col gap-4 items-center justify-center ">
        ...
        <div className="gap-4 text-center">
          ...
          <p className="text-black-900 text-sm">
            ...
            event mahasiswa di lingkungan Fakultas Teknik UGM.
            <br />
            Platform ini digunakan untuk mencari dan mengajukan event agar
            seluruh mahasiswa FT UGM mengetahui event apa saja yang ada di
            fakultasnya dan dapat mendaftarkan dirinya.
          </p>
        </div>
      </div>
    </main>
